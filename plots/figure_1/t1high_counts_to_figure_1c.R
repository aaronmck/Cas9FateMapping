...
events <- read.delim("event_histogram_t1high.txt")
...
ggsave(glog,file="log_edit_sizes_t1high.pdf",width=15,height=6)
...
gnorm = ggplot() + 
  ...
  ylab("Occurance") + 
  xlab("Insertion or deletion size")
ggsave(gnorm,file="nonlog_edit_sizes_t1high.pdf",width=15,height=6)

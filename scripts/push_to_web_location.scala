...
val javaScriptFile = new File("/net/shendure/vol10/projects/CRISPR.lineage/nobackup/codebase/plots/read_editing_mutlihistogram.js")
val htmlFile = new File("/net/shendure/vol10/projects/CRISPR.lineage/nobackup/codebase/plots/read_editing_mutlihistogram.html")
...
fileList.write("var cut_site_offset = 111\n")
fileList.close()
